...
<div class="login">
    <form class="form1" id="form1" method="post" action="login">
        ...
        <label for="user_id" class="sr-only">Text</label>
        <input type="text" name="user_id" id="user_id" class="form-control" placeholder="学号" required
               oninvalid="setCustomValidity('学号不能为空')" oninput="setCustomValidity('')" autofocus>
        ...
        <button class="btn btn-lg btn-primary btn-block" onclick="location.href='register.jsp'" type="submit">注册
        </button>
